...
export const unitEmSnippets: HandbookSnippet[] = [
  {
    ...
    controls: [
      control('em-box-size', '박스 너비', 'itemA', 'em-box-10', [
        option('box8', '8em (128px)', 'em-box-8', [
          { selector: '.child', property: 'width', value: '8em' },
        ]),
        option('box10', '10em (160px)', 'em-box-10', [
          { selector: '.child', property: 'width', value: '10em' },
        ]),
        option('box14', '14em (224px)', 'em-box-14', [
          { selector: '.child', property: 'width', value: '14em' },
        ]),
      ]),
    ],
    mdnLinks: [
  ...
  },
  {
    ...
    controls: [
      control('em-text-size', 'font-size', 'itemA', 'em-text-1', [
        option('text0875', '0.875em (15.75px)', 'em-text-0875', [
          { selector: '.child', property: 'font-size', value: '0.875em' },
        ]),
        option('text1', '1em (18px)', 'em-text-1', [
          { selector: '.child', property: 'font-size', value: '1em' },
        ]),
        option('text14', '1.4em (25.2px)', 'em-text-14', [
          { selector: '.child', property: 'font-size', value: '1.4em' },
        ]),
      ]),
    ],
    mdnLinks: [
