...
const NAV_CLASS =
  'sticky top-0 z-(--ds-z-sticky) flex items-center justify-center gap-6 border-b border-border bg-surface-raised px-gutter py-4';

const BRAND_CLASS =
  'absolute left-gutter text-label tracking-widest text-subtle uppercase';
